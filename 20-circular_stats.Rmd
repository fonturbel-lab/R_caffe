...
Here we have the observed overlap coefficient (think about it as a percentage), the null model overlap, and the P-value. As the P-value is calculated using permutations, the more permutations the more robust results we'll get. Of course more permutations demand more CPU and may take much longer is slow computers.

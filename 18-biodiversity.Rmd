...
Today we will learn how to analyze and make sense of our biodiversity data (after long campaigns in the field collecting data... really exhausting)
...
#Loading work data
data = read.csv("data/data_cn.csv",
                   header=TRUE,
                   sep=",")

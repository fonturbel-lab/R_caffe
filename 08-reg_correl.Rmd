...
So far, we have dealt with a continuous response variable contrasted against categorical predictors. But in many cases we have continuous predictors that

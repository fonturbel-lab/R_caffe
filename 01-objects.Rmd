...
Before start analyzing our data, it is always a good idea to make simple plots to decribe our data. For example, how are sepal lenght values distributed? let's make an histogram:

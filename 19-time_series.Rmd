...
#Jilguero-Canelo
decompose(carcan)
fit.carcan<-stl(carcan, "periodic")
plot(fit.carcan, main="Jilguero-Canelo")
monthplot(carcan, main="Jilguero-Canelo")
seasonplot(carcan, main="Jilguero-Canelo")
##
#Jilguero-Notro
decompose(carnot)
fit.carnot<-stl(carnot, "periodic")
plot(fit.carnot, main="Jilguero-Notro")
monthplot(carnot, main="Jilguero-Notro")
seasonplot(carnot, main="Jilguero-Notro")
##
#Fiofio-Canelo
decompose(elacan)
fit.elacan<-stl(elacan, "periodic")
plot(fit.elacan, main="Fiofio-Canelo")
monthplot(elacan, main="Fiofio-Canelo")
seasonplot(elacan, main="Fiofio-Canelo")
##
#Fiofio-Notro
decompose(elanot)
fit.elanot<-stl(elanot, "periodic")
plot(fit.elanot, main="Fiofio-Notro")
monthplot(elanot, main="Fiofio-Notro")
seasonplot(elanot, main="Fiofio-Notro")
##
#Cometocino-Canelo
decompose(phrcan)
fit.phrcan<-stl(phrcan, "periodic")
plot(fit.phrcan, main="Cometocino-Canelo")
monthplot(phrcan, main="Cometocino-Canelo")
seasonplot(phrcan, main="Cometocino-Canelo")
##
#Cometocino-Notro
decompose(phrnot)
fit.phrnot<-stl(phrnot, "periodic")
plot(fit.phrnot, main="Cometocino-Notro")
monthplot(phrnot, main="Cometocino-Notro")
seasonplot(phrnot, main="Cometocino-Notro")
##
#Chercan-Canelo
decompose(trocan)
fit.trocan<-stl(trocan, "periodic")
plot(fit.trocan, main="Chercan-Canelo")
monthplot(trocan, main="Chercan-Canelo")
seasonplot(trocan, main="Chercan-Canelo")
##
#Chercan-Notro
decompose(tronot)
fit.tronot<-stl(tronot, "periodic")
plot(fit.tronot, main="Chercan-Notro")
monthplot(tronot, main="Chercan-Notro")
seasonplot(tronot, main="Chercan-Notro")
##
#Zorzal-Canelo
decompose(turcan)
fit.turcan<-stl(turcan, "periodic")
plot(fit.turcan, main="Zorzal-Canelo")
monthplot(turcan, main="Zorzal-Canelo")
seasonplot(turcan, main="Zorzal-Canelo")
##
#Zorzal-Notro
decompose(turnot)
fit.turnot<-stl(turnot, "periodic")
plot(fit.turnot, main="Zorzal-Notro")
monthplot(turnot, main="Zorzal-Notro")
seasonplot(turnot, main="Zorzal-Notro")
##
#Chincol-Canelo
decompose(zoncan)

...
To illustrate this point we will use the _dietox_ example data file from the `pscl` package.


## Final thoughts

Relaxing other assumptions allow us to properly analyze other kind of data. 
